...
@Component({
  selector: 'ResearcherSkeleton-home',
  templateUrl: './ResearcherSkeleton-home.component.html',
  styleUrls: ['./ResearcherSkeleton-home.component.scss']
})
export class ResearcherSkeletonHomeComponent implements AfterViewInit {
