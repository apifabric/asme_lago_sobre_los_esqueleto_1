...
@Component({
  selector: 'BoneTypeFunction-home',
  templateUrl: './BoneTypeFunction-home.component.html',
  styleUrls: ['./BoneTypeFunction-home.component.scss']
})
export class BoneTypeFunctionHomeComponent implements AfterViewInit {
