...
@Component({
  selector: 'Analysi-home',
  templateUrl: './Analysi-home.component.html',
  styleUrls: ['./Analysi-home.component.scss']
})
export class AnalysiHomeComponent implements AfterViewInit {
