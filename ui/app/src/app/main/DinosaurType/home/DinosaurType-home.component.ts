...
@Component({
  selector: 'DinosaurType-home',
  templateUrl: './DinosaurType-home.component.html',
  styleUrls: ['./DinosaurType-home.component.scss']
})
export class DinosaurTypeHomeComponent implements AfterViewInit {
