...
@Component({
  selector: 'SkeletonDinosaurType-home',
  templateUrl: './SkeletonDinosaurType-home.component.html',
  styleUrls: ['./SkeletonDinosaurType-home.component.scss']
})
export class SkeletonDinosaurTypeHomeComponent implements AfterViewInit {
