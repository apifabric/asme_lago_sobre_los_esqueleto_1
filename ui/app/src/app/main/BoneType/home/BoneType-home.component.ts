...
@Component({
  selector: 'BoneType-home',
  templateUrl: './BoneType-home.component.html',
  styleUrls: ['./BoneType-home.component.scss']
})
export class BoneTypeHomeComponent implements AfterViewInit {
