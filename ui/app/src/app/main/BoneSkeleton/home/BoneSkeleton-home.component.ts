...
@Component({
  selector: 'BoneSkeleton-home',
  templateUrl: './BoneSkeleton-home.component.html',
  styleUrls: ['./BoneSkeleton-home.component.scss']
})
export class BoneSkeletonHomeComponent implements AfterViewInit {
