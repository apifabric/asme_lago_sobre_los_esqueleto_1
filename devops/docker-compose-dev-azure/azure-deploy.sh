...
resourcename="asmelagosobrelosesqueleto1"  # lower case, only
resourcegroup="asmelagosobrelosesqueleto1_rg"
...
# git clone https://github.com/apilogicserver/asmelagosobrelosesqueleto1.git
# cd asmelagosobrelosesqueleto1
...
az group create --name asmelagosobrelosesqueleto1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group asmelagosobrelosesqueleto1_rg --sku S1 --is-linux
az container create --resource-group asmelagosobrelosesqueleto1_rg --name asmelagosobrelosesqueleto1 --image apilogicserver/asmelagosobrelosesqueleto1:latest --dns-name-label asmelagosobrelosesqueleto1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//asmelagosobrelosesqueleto1.westus.azurecontainer.io:5656'
